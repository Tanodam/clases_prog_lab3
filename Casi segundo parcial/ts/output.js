...
(function (model) {
    ...
    })(sexo = model.sexo || (model.sexo = {}));
    var Persona = /** @class */ (function () {
        function Persona(nombre, apellido, email, edad, sex) {
            this._id = 1; //TODO
            this._nombre = nombre;
        ...
        Object.defineProperty(Persona.prototype, "sex", {
            get: function () {
                return this._sexo;
            },
            set: function (s) {
...
(function (model) {
    ...
    })(tipo = model.tipo || (model.tipo = {}));
    var Legislador = /** @class */ (function (_super) {
        __extends(Legislador, _super);
        function Legislador(nombre, apellido, email, edad, sexo, tipos) {
            var _this = _super.call(this, nombre, apellido, email, edad, sexo) || this;
            _this._tipo = tipos;
            return _this;
        }
        Object.defineProperty(Legislador.prototype, "tipos", {
            get: function () {
                return this._tipo;
            },
            set: function (t) {
